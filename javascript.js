...
incomeAndExpenses.addEventListener("submit", function (e) {
  ...
  if (
    ...
    if (balanceValue < 0) {
      ...
      Toastify({
        text: "Calculation complete! Your total expenses have been deducted from your income.",
        duration: 3000, // Duration of the toast
        close: true, // Show close button
        gravity: "top", // Position (top/bottom)
        position: "center", // Align (left/right/center)
    ...
    if (checkSaveValue == true) {
      ...
      if (!isNaN(balance)) {
        ...
        if (totalRemaining < 0) {
          ...
          Toastify({
            text: "Savings complete! Your total expenses have been deducted from your income.",
            duration: 3000, // Duration of the toast
            close: true, // Show close button
            gravity: "top", // Position (top/bottom)
            position: "center", // Align (left/right/center)
